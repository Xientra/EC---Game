...
HRESULT Terrain::create(ID3D11Device* device)
{
    ...
    //V(DirectX::CreateDDSTextureFromFile(device, L"C:\\_Computerstuff\\Informatik - Games Engineering\\SS 2020\\Praktikum Echtzeit Computergrafik\\hemming\\GEDGame_VS2019\\x64\\Release\\resources\\debug_green.dds", nullptr, &debugSRV));
    ...
    */
    ...
    SimpleImage heightmapImage = SimpleImage((resourcesPath + terrainPath).c_str());//SimpleImage(("resources\\" + terrainPath).c_str());
...
#pragma region load color texture
